...
const MyComplaints = () => {
  ...
  const handleDeleteComplaint = async (complaintId) => {
    ...
    Swal.fire({
      ...
      text: `Are you sure you want to permanently delete Ticket #${complaintId}? This will remove it from the municipal database.`,
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          setComplaints(prev => prev.filter(c => c.id !== complaintId && c.ticketId !== complaintId && c._id !== complaintId));
            ...
            <div className="vault-complaints-list">
              {isLoading ? (
                ...
                filteredComplaints.map(c => {
                  ...
                  return (
                    <div key={c.id} className="clean-vault-card" >
                      {/* Top Header Row */}
